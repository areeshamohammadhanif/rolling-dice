...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  main.MyApp = class MyApp extends framework.StatelessWidget {
    ...
    build(context) {
      return new app.MaterialApp.new({title: "Dice Roller", theme: theme_data.ThemeData.new({primarySwatch: colors.Colors.blue}), home: new main.HomeScreen.new()});
    }
  };
  ...
  main._HomeScreenState = class _HomeScreenState extends framework.State$(main.HomeScreen) {
    rollDice() {
      this.setState(dart.fn(() => {
        this.diceOne = math.Random.new().nextInt(6) + 1;
        this.diceTwo = math.Random.new().nextInt(6) + 1;
      }, T.VoidTovoid()));
    }
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({backgroundColor: colors.Colors.blueAccent, centerTitle: true, title: new text.Text.new("Dice Rolling Project")}), body: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.spaceEvenly, children: T.JSArrayOfWidget().of([new basic.Row.new({mainAxisAlignment: flex.MainAxisAlignment.spaceEvenly, children: T.JSArrayOfWidget().of([new image.Image.asset("assets/appimages/" + dart.str(this.diceOne) + ".png", {height: 100, width: 100}), new image.Image.asset("assets/appimages/" + dart.str(this.diceTwo) + ".png", {height: 100, width: 100})])}), new elevated_button.ElevatedButton.new({onPressed: dart.bind(this, 'rollDice'), child: new text.Text.new("Roll dice", {style: new text_style.TextStyle.new({fontSize: 18})})})])})});
    }
  ...
  dart.setMethodSignature(main._HomeScreenState, () => ({
    ...
    rollDice: dart.fnType(dart.void, []),
    build: dart.fnType(framework.Widget, [framework.BuildContext])
  }));
  ...
  dart.setFieldSignature(main._HomeScreenState, () => ({
    ...
    diceOne: dart.fieldType(core.int),
    diceTwo: dart.fieldType(core.int)
  }));
  ...
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;UC3C4B;AACxB,YAAO,iCACE,sBACA,yCAAgC,4BACjC;IAEV;;;QAVmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;;;;;;AAiBW;IAAkB;;;QAHnC;AAAlB,mDAAkB,GAAG;;EAAE;;;;;;;;;;AAanB,MAHF,cAAS;AACyB,QAAhC,eAAU,AAAS,AAAW,0BAAH,KAAI;AACC,QAAhC,eAAU,AAAS,AAAW,0BAAH,KAAI;;IAEnC;UAG0B;AACxB,YAAO,oCACG,yCACkB,uCACX,aACN,kBAAK,iCAER,yCACiC,8CAC3B,wBACR,sCACuC,8CAC3B,wBACF,sBAAM,AAAiC,+BAAb,gBAAQ,iBAAe,YAAY,OAC7D,sBAAM,AAAiC,+BAAb,gBAAQ,iBAAe,YAAY,WAGvE,6DACa,0BACJ,kBAAK,qBAAoB,wCAAoB;IAK9D;;;;;;IAlCI,eAAW;IAAG,eAAU;;;EAmC9B;;;;;;;;;;;;;;;;AA5DuB,IAArB;EACF;;ECEwB","file":"main.js"}');
  // Exports:
  return {
